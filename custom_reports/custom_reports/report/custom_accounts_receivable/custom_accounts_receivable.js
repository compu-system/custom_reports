...
frappe.query_reports["Custom Accounts Receivable"] = {
	...
	onload: function(report) {
		report.page.add_inner_button(__("Custom Accounts Receivable Summary"), function() {
			var filters = report.get_values();
			frappe.set_route('query-report', 'Custom Accounts Receivable Summary', {company: filters.company});
		});
	}
};
