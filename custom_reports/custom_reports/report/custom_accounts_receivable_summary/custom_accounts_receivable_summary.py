...
from custom_reports.custom_reports.report.custom_accounts_receivable.custom_accounts_receivable import CustomReceivablePayableReport
...
class CustomAccountsReceivableSummary(CustomReceivablePayableReport):
	def run(self, args):
	...
	def get_data(self, args):
		...
		self.receivables = CustomReceivablePayableReport(self.filters).run(args)[1]
